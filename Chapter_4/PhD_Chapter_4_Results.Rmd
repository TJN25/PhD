...
pcAlifoldScore <- read.table("chapter_4_files/positive_control_alifold_score.txt")
ncAlifoldScore <- read.table("chapter_4_files/negative_control_alifold_score.txt")
predAlifoldScore <- read.table("chapter_4_files/predicted_alifold_score.txt")
...
save(pcAlifoldScore, file= "chapter_4_files/pcAlifoldScore.Rda")
save(ncAlifoldScore, file= "chapter_4_files/ncAlifoldScore.Rda")
save(predAlifoldScore, file= "chapter_4_files/predAlifoldScore.Rda")
```
...
load("chapter_4_files/pcAlifoldScore.Rda")
load("chapter_4_files/ncAlifoldScore.Rda")
pcSRNACounts <- read.table("chapter_4_files/positive_control_snra_counts.txt")
ncSRNACounts <- read.table("chapter_4_files/negative_control_snra_counts.txt")
...
load("~/bin/PhD_Chapters_Code/Chapter 3/chapter_4_files/validation_gz.Rda")
...
save(validation2, file = "chapter_4_files/validatation2.Rda")
```
...
save(featuresSelected, file="~/bin/PhD_Chapters_Code/Chapter 3/chapter_4_files/featuresSelected_gz.Rda")
...
write_data <- T
if(write_data){
ggsave(filename = "~/bin/PhD/Chapter_4/chapter_4_files/probabilites_rf_log_gz.svg", plot = p, width = 178, height = 155, units = "mm")
}
```

```{r score_values, eval=TRUE}
load("~/bin/PhD_Chapters_Code/Chapter 3/chapter_4_files/predDat.Rda")

load("~/bin/PhD_Chapters_Code/Chapter 3/chapter_4_files/validatation2.Rda")
...
load("~/bin/PhD/Chapter_4/chapter_4_files/featuresSelected_gz.Rda")
