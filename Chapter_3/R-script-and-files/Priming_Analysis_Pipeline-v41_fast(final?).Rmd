...
IMGswipeData.In<- read.table("refseq_83_swipe_setup_IMG_INCOMPLETE.txt", comment.char = "", fill = T, sep = "\t", header = T, quote = "", as.is = T)
...
write.csv(Counts,paste(Out.Dir,"Data_Count_Table_SJ-v14.csv",sep=""))
...
hits<-noramlise_distribution_values(hits)
 write.csv(hits, file = paste("Output/Analysis/Protospacer_mapping_",i,".csv", sep = ""), row.names = F)
