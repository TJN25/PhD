...
repeatsFoundSingleSubtype <- repeatsFound%>%filter(subtype.count == 1)%>%select(-subtype.count)
repeatsFoundMultipleSubtypes <- repeatsFound%>%filter(subtype.count != 1)%>%select(-subtype.count)

repeatsFound <- repeatsFoundSingleSubtype
